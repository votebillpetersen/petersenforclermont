  ...
  "@graph": [
    {
      ...
      description:
        "Incumbent Clermont City Council member, Seat 5. Running for re-election in the General Election on November 3, 2026.",
    ...
    {
      "@type": "Election",
      name: "2026 Clermont City Council Seat 5 General Election",
