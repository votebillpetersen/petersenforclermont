...
export const metadata: Metadata = {
  ...
  description:
    "Contribute to the Bill Petersen campaign for Clermont City Council Seat 5. Local campaigns are powered by neighbors. Vote November 3, 2026.",
  alternates: { canonical: "/donate" },
  openGraph: {
    title: "Donate to Bill Petersen | Clermont City Council Seat 5",
    description:
      "Contribute to the Bill Petersen campaign for Clermont City Council Seat 5. Vote November 3, 2026.",
    url: "/donate",
    type: "website",
    images: [
      {
